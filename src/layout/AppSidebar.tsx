...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Device Monitor", path: "/mikrotik/device", pro: false },
  ...
  },
  {
    ...
    path: "/mikrotik/billing/invoices",
  },
  {
    icon: <PieChartIcon />,
    name: "Transaksi Keuangan",
    path: "/mikrotik/billing/transactions",
  },
  {
    icon: <BoxCubeIcon />,
    name: "Master Data",
    subItems: [
      ...
      { name: "Kategori Transaksi", path: "/mikrotik/billing/categories", pro: false },
    ],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" className="font-bold text-xl text-gray-900 dark:text-white Outfit">
          {isExpanded || isHovered || isMobileOpen ? (
            "Admin Wifi" // Teks panjang saat sidebar terbuka
          ) : (
            "MT" // Teks inisial saat sidebar dikecilkan
          )}
        </Link>
